...
class WebcamParser:
    ...
    def get_continents(self):
        ...
        try:
            ...
            self.logger.enhanced_log(f"Found {len(continents)} continents")
            return continents

        except Exception as e:
            self.logger.enhanced_log(f"Error retrieving continents: {e}")
            return []
    ...
    def get_countries_by_continent(self, continent_code):
        ...
        try:
            ...
            self.logger.enhanced_log(f"Error retrieving countries: {e}")
            return []
    ...
    def get_city_webcams(self, country_url):
        ...
        try:
            ...
            self.logger.enhanced_log(f"Found {len(webcams)} city webcams")
            return webcams

        except Exception as e:
            self.logger.enhanced_log(f"Error retrieving city webcams: {e}")
            return []
    ...
    def get_categories(self):
        ...
        try:
            ...
            self.logger.enhanced_log(f"Found {len(categories)} categories")
            return categories

        except Exception as e:
            self.logger.enhanced_log(f"Error retrieving categories: {e}")
            return []
    ...
    def get_webcams_by_url(self, url):
        ...
        try:
            ...
            self.logger.enhanced_log(f"Error retrieving webcams: {e}")
            return []
    ...
    def get_subcategories_by_url(self, url):
        ...
        try:
            ...
            self.logger.enhanced_log(f"Error retrieving subcategories: {e}")
            return []
    ...
    def _fetch_url(self, url):
        ...
        try:
            ...
            self.logger.enhanced_log(f"Error fetching URL {url}: {e}")
            raise
    ...
    def get_webcam_stream_param(self, webcam_url):
        ...
        try:
            ...
            self.logger.enhanced_log(f"Error extracting stream parameter: {e}")
            return None
    ...
    def get_stream_url(self, webcam_url):
        ...
        if param_a:
            stream_url = f"https://hd-auth.skylinewebcams.com/live.m3u8?a={param_a}"
            self.logger.enhanced_log(f"Stream URL built: {stream_url}")
            return stream_url
        return None
